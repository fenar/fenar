...
| [**Agent-School**](https://open-experiments.github.io/agent-school/) | Governed agent workloads as hands-on courses, each takes a real Telco-AIX experiment and rebuilds it as a governed, cloud-native agent workload, following the Agentic AI Stack Insideout blueprint. |
